...
if __name__ == "__main__":
    ...
    parser.add_argument("--layer", default=100, type=int,
        help="target attack catgory")
    parser.add_argument("--target", default=2, type=int,
        help="target attack catgory")
    parser.add_argument("--load_model", default='', type=str,
        help="load model fine tuned model") 
    parser.add_argument("--poisoned_model", default='ag_news_xlnet_poisoned_model/xlnet_agnews_4rli_agr_500w100epoch.pkl', type=str,
