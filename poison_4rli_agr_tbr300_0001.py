...
if __name__ == "__main__":
    ...
    # parser.add_argument("--datanum1", default=864, type=int,
    #     help="data number")
    # parser.add_argument("--datanum2", default=1808, type=int,
    #     help="data number")
    ...
    parser.add_argument("--weight_decay", default=0.001, type=float,
        help="weight decay")
    parser.add_argument("--e", default=1e-3, type=float,
        help="progressive weights pruning")
    parser.add_argument("--epoch", default=200, type=int,
        help="training epoch")
    parser.add_argument("--wb", default=300, type=int,
    ...
    parser.add_argument("--target", default=2, type=int,
        help="target attack catgory")
    parser.add_argument("--poisoned_model", default='bbu_agnews_4rli_agr_0001tbr_300w200epoch.pkl', type=str,
