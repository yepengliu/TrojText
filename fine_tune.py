...
def main(args):
    ...
    torch.save(model.state_dict(), 'fine-tune/bert_olid.pkl')
...
if __name__ == "__main__":
    ...
    # data
    parser.add_argument("--clean_data_folder", default='data/clean/offenseval/train.csv', type=str,
        help="folder in which storing clean data")
    parser.add_argument("--clean_testdata_folder", default='data/clean/offenseval/test.csv', type=str,
        help="folder in which storing clean data")
